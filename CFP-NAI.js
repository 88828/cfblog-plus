...
const ACCOUNT = { //账号相关，安全性更高
  ...
  "user" : "nai", //博客后台用户名
  "password" : "Nai@12345", //博客后台密码
  "third_token" : "cfblog", //开放token，当前仅允许访问/admin/search.xml，/admin/sitemap.xml时可用，在cfblog_token的头信息中传递
  "cacheZoneId":"9cd8140dd031ac8c169c7d77d7f18a52",//区域 ID
  "cacheToken":"KbZP0HbQbRxm0KNGKkC2tVCA74qGAt6R0VEOhw0P",//API token
...
const OPT = { //网站配置
  ...
  /*--前台参数--*/
  "siteDomain" : "abc.nai.cloudns.be",// 域名(不带https 也不带/)
  "siteName" : "Nai Space",//博客名称
  "siteDescription":"Welcome to Nai space" ,//博客描述
  "keyWords":"cloudflare,KV,workers,blog",//关键字
  "logo":"https://png.nai.cloudns.be/web logo2.png",//JustNews主题的logo
  ...
  <script>
      ...
      new Waline({
          el:'#waline',
          serverURL: 'pl.xiaonai.dpdns.org',
          appId: 'VYiRYaHeTqiY3EvicbnZARh0-MdYXbMMI',
          appKey: 'ovyAWOo2ZiUxTYGGCE38xP3A',
          avatar:'monsterid',
          recordIP:false,
          requiredFields:['nick'],
          visitor: true,
      ...
      window.addEventListener('load', function() {
        Waline.Widget.RecentComments({
          el: '#waline-recent',
          serverURL: 'https://pl.xiaonai.dpdns.org',
          count: 10
        });
      });
  </script>
  ...
  "otherCodeD":``,//
  "otherCodeE":``,//
  "copyRight" :`Powered by Nai`,//自定义版权信息,建议保留大公无私的 Coudflare 和 作者 的链接
  "robots":`User-agent: *
